...
function App() {
  ...
  const [selectedTotalQues, setSelectedTotalQues] =
    useState(DEFAULT_TOTAL_QUES); // Default total questions
      ...
      {userAnswers.length !== selectedTotalQues && (
        <div className="max-md:mt-[4rem] mb-8 md:mb-14">
          <img
            src={quiz}
            alt="quiz pic"
            className="w-[10rem] h-[10rem] bg-center "
          />
        </div>
      )}
      <div className="w-full  md:w-[50vw] text-blue-600 h-full md:h-[50vh]">
        <div
          className={`flex  flex-col mt-24 lg:mt-0 gap-4 justify-center items-center ${
        ...
        >
          <div className="flex flex-col gap-3 ">
            <div className=" flex  gap-6">
              ...
              <select
                id="difficulty"
                className="bg-stone-200 rounded-md outline-none"
          ...
          <button
            className="px-3 py-2 rounded-xl bg-blue-700 font-montserrat text-stone-200 text-xl hover:bg-blue-600 hover:scale-105 hover:text- duration-100 ease-in-out"
            onClick={startQuiz}
          >
            Start Quiz
          </button>
        ...
        {userAnswers.length === selectedTotalQues && (
          <Result score={score} totalQues={selectedTotalQues} />
        )}

        {loading && (
          <p className="text-blue-700 font-sedan text-center text-3xl">
            Loading Questions...
          </p>
        )}
        ...
        <div className="w-full flex justify-center items-center">
          ...
          number !== selectedTotalQues - 1 ? (
            <button
              className="px-3 py-2 mt-4 text-montserrat text-lg rounded-lg text-stone-200 hover:text-stone-100 bg-blue-700 hover:bg-blue-600 scale-105 duration-75 "
