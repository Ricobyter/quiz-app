...
const QuestionCard: React.FC<Props> = ({
  ...
  <div className="font-montserrat w-[90%] md:w-[80%] flex flex-col justify-center items-center p-4 rounded-xl ">
    <div className="flex w-full items-center justify-center">
      <p
        className="text-xl font-semibold lg:w-[50vw] bg-gradient-to-r text-blue-500  border-2 border-orange-700 bg-stone-100 rounded-xl  px-4 py-3  mb-8   text-center"
